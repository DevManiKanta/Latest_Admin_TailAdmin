...
const TextArea = ({
  ...
  return (
    React.createElement('div', { className: "relative", __self: this, __source: {fileName: _jsxFileName, lineNumber: 41}}
      , React.createElement('textarea', {
        ...
        disabled: disabled,
        className: textareaClasses, __self: this, __source: {fileName: _jsxFileName, lineNumber: 42}}
      )
      , hint && (
